...
from mechanics.blueprints.admin import admin_bp
from mechanics.blueprints.ajax import ajax_bp
from mechanics.blueprints.auth import auth_bp
...
def register_commands(app):
    ...
    @click.option('--follow', default=10, help='Quantity of follows, default is 50.')
    @click.option('--photo', default=10, help='Quantity of photos, default is 500.')
    @click.option('--tag', default=10, help='Quantity of tags, default is 500.')
    @click.option('--collect', default=10, help='Quantity of collects, default is 500.')
    ...
    def forge(user, follow, photo, tag, collect, comment, material, extensometer, geometry, experiment):
        ...
        from mechanics.fakes import fake_admin, fake_comment, fake_follow, fake_photo, fake_tag, fake_user, fake_collect, fake_material, fake_extensometer, fake_geometry, fake_experiment
        ...
        click.echo('Generating %d materials...' % material)
        fake_material(material)
        click.echo('Generating %d extensometers...' % extensometer)
        fake_extensometer(extensometer)
        click.echo('Generating %d geometries...' % geometry)
