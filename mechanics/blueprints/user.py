...
from mechanics.emails import send_change_email_email
from mechanics.extensions import db, avatars
from mechanics.forms.user import EditProfileForm, UploadAvatarForm, CropAvatarForm, ChangeEmailForm, \
    ChangePasswordForm, NotificationSettingForm, PrivacySettingForm, DeleteAccountForm
from mechanics.models import User, Photo, Collect
from mechanics.notifications import push_follow_notification
from mechanics.settings import Operations
from mechanics.utils import generate_token, validate_token, redirect_back, flash_errors
